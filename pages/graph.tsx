      ...
      <main className={styles.main}>
        <div className={styles.mainmain}>
          ...
          <div className={styles.textBlurb}>
            ...
            <p>{`So, for instance, I liked around 1,300 tweets that were created in the first quarter of 2018. According to my assumption, this would indicate that I spent more time on Twitter in the first quarter of 2018 than I did in the first quarter of 2019, as I've only liked around 800 tweets from the first quarter of 2019. The validity of my conclusion rests on that assumption, but like I said, it seems to be a pretty reasonable assumption to me.`} </p>

...
const Home: NextPage = () => {
      ...
      <main className={styles.main}>
        <div className={styles.mainmain}>
          ...
          <div className={styles.textBlurb}>
            ...
            <div className={styles.code + " " + styles.codeDataFromTwitterDesktop}>
  ...
  "data": [
    ...
    ...
    {
      ...
      "text": "why does every open‐source React application on 
    ...
    ...
    {
      ...
      "text": "i hate this weather i’m dying😵‍💫 
...
"meta": {
    ...
    "next_token": "7140dibdnow9c7btw481d30shnq9yvr7mxcbe41hq6wc8"
            ...
            <div className={styles.code}>
              {/* this one will show up when viewing on mobile  */}
              <pre>
                {`{
 "data": [
 {
  "created_at": "2022-07-20T20
  :49:42.000Z",
  "id": "1549859114070773764",
  "text": "full metal alchemis
  t: brotherhood - rain (2010) 
  https://t.co/JQHT2DIcQB"
 },
...
 {
  "created_at": "2022-07-04T20
  :44:33.000Z",
  "id": "1544059613481504771",
  "text": "why does every open‐
  source React application on 
  GitHub put an emoji before 
  every header on their README. 
  like we get it, you use React"
 },
...
 {
  "created_at": "2022-06-11T02
  :14:35.000Z",
  "id": "1535445358481797120",
...
...
 ...
 "meta": {
  "result_count": 95,
  "next_token": "7140dibdnow9c7b
  tw481d30shnq9yvr7mxcbe41hq6wc8"
 }
}`}
              </pre>
            </div>

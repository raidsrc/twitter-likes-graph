      ...
      <main className={styles.main}>
        <div className={styles.mainmain}>
          ...
          <div className={styles.textBlurb}>
            <p>{`I've had COVID-19 these past couple weeks. It's really sucked. I don't get sick too often, but when I do get sick, I get really sick, and getting hit by COVID-19 has been no different. I haven't got much to do besides eat, sleep, take drugs, and recover. `}</p>
